...
class EmailSender(EmailSenderInterface):
    ...
    async def _send_email(self, recipient: str, subject: str, text_content: str) -> None:
        """
    ...
    async def send_password_reset_email(self, email: str, reset_token_complete: str) -> None:
