...
async def create_certification(certification: BaseCreateSchema, certification_service: CertificationService = Depends(get_certification_service)):
...
async def read_certification(certification_id: int, certification_service: CertificationService = Depends(get_certification_service)):
...
async def read_certifications(certification_service: CertificationService = Depends(get_certification_service)):
...
async def delete_certification(certification_id: int, certification_service: CertificationService = Depends(get_certification_service)):
    db_certification = await certification_service.delete_certification(certification_id)
