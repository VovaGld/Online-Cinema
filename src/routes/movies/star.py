...
async def create_star(star: BaseCreateSchema, star_service: StarService = Depends(get_star_service)):
...
async def read_star(star_id: int, star_service: StarService = Depends(get_star_service)):
...
async def delete_star(star_id: int, star_service: StarService = Depends(get_star_service)):
