...
async def create_genre(genre: BaseCreateSchema, genre_service: GenreService = Depends(get_genre_service)):
...
async def read_genre(genre_id: int, genre_service: GenreService = Depends(get_genre_service)):
...
async def delete_genre(genre_id: int, genre_service: GenreService = Depends(get_genre_service)):
